...
python3 multiproc.py --nproc_per_node 2 train_classification.py -a wide_resnet22_1 --data-backend 'dali-gpu' --opt 'sgd' -nc 10 -e 5  --lr 0.01 -b 256 --fp16 --opt-level 'O2' "../cv_data/cifar10/train" "../cv_data/cifar10/test"
# 
