...
python3 train_classification.py -a wide_resnet22_1_swish --data-backend 'dali-cpu' --opt 'ranger' -nc 10 -e 10  --lr 0.02 -b 64 --fp16 --opt-level 'O1' "../cv_data/cifar10/train" "../cv_data/cifar10/test"
