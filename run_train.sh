...
python3 multiproc.py --nproc_per_node 2 train_classification.py -a wide_resnet22_2 --data-backend 'dali-gpu' --opt 'ranger' -nc 10 -e 8  --lr 0.02 -b 256 --fp16 --opt-level 'O2' "../cv_data/cifar10/train" "../cv_data/cifar10/test"
python3 multiproc.py --nproc_per_node 2 train_classification.py -a wide_resnet22_4 --data-backend 'dali-gpu' --opt 'ranger' -nc 10 -e 8  --lr 0.02 -b 256 --fp16 --opt-level 'O2' "../cv_data/cifar10/train" "../cv_data/cifar10/test"
python3 multiproc.py --nproc_per_node 2 train_classification.py -a wide_resnet22_8 --data-backend 'dali-gpu' --opt 'ranger' -nc 10 -e 8  --lr 0.02 -b 256 --fp16 --opt-level 'O2' "../cv_data/cifar10/train" "../cv_data/cifar10/test"
