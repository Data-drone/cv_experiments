...
python3 train_classification.py -a resnet18 --data-backend 'dali-cpu' --opt 'ranger' -nc 10 -e 10  --lr 0.02 -b 256 --fp16 --opt-level 'O1' "../cv_data/cifar10/train" "../cv_data/cifar10/test"
